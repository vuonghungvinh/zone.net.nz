...
from .sitemaps import StaticPagesSitemap, CatalogueSitemap, SubCatalogueSitemap, ProductSitemap, ProductGapWidthSitemap, \
    ProjectSitemap
# Static views
...
sitemaps = {
    ...
    'subcatalogue': SubCatalogueSitemap,
    'product': ProductSitemap,
    'productgapwidth': ProductGapWidthSitemap,
