...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Entry.file'
        db.alter_column(u'projects_entry', 'file', self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True))

    def backwards(self, orm):

        # Changing field 'Entry.file'
        db.alter_column(u'projects_entry', 'file', self.gf('django.db.models.fields.files.FileField')(default=0, max_length=100))
