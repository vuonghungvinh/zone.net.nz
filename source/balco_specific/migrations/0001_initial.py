...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'balco_specific_positionapplication', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('updated', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
        ))
        db.send_create_signal(u'balco_specific', ['PositionApplication'])

        # Adding model 'InteriorExterior'
        db.create_table(u'balco_specific_interiorexterior', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('updated', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
        ))
        db.send_create_signal(u'balco_specific', ['InteriorExterior'])

        # Adding model 'CoverType'
        db.create_table(u'balco_specific_covertype', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('updated', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
        ))
        db.send_create_signal(u'balco_specific', ['CoverType'])
        ...
        db.create_table(u'balco_specific_gapwidth', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('updated', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
        ))
        db.send_create_signal(u'balco_specific', ['GapWidth'])

        # Adding model 'Movement'
        db.create_table(u'balco_specific_movement', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('updated', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
        ))
        db.send_create_signal(u'balco_specific', ['Movement'])


    def backwards(self, orm):
        # Deleting model 'PositionApplication'
        db.delete_table(u'balco_specific_positionapplication')

        # Deleting model 'InteriorExterior'
        db.delete_table(u'balco_specific_interiorexterior')

        # Deleting model 'CoverType'
        db.delete_table(u'balco_specific_covertype')

        # Deleting model 'FireRating'
        db.delete_table(u'balco_specific_firerating')

        # Deleting model 'GapWidth'
        db.delete_table(u'balco_specific_gapwidth')

        # Deleting model 'Movement'
        db.delete_table(u'balco_specific_movement')
