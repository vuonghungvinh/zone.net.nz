...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ExplainationCopy'
        db.create_table(u'balco_specific_explainationcopy', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('content', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('field', self.gf('django.db.models.fields.IntegerField')(default=1, null=True, blank=True)),
            ('created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('updated', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
        ))
        db.send_create_signal(u'balco_specific', ['ExplainationCopy'])


    def backwards(self, orm):
        # Deleting model 'ExplainationCopy'
        db.delete_table(u'balco_specific_explainationcopy')
