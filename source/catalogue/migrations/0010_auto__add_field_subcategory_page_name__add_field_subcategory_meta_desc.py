...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SubCategory.page_name'
        db.add_column(u'catalogue_subcategory', 'page_name',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'SubCategory.meta_description'
        db.add_column(u'catalogue_subcategory', 'meta_description',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SubCategory.page_name'
        db.delete_column(u'catalogue_subcategory', 'page_name')

        # Deleting field 'SubCategory.meta_description'
        db.delete_column(u'catalogue_subcategory', 'meta_description')
