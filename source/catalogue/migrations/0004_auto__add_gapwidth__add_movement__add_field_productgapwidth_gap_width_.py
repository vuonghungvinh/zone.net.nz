...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ProductGapWidth.gap_width_finder'
        db.add_column(u'catalogue_productgapwidth', 'gap_width_finder',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='gap_widths', null=True, to=orm['catalogue.GapWidth']),
                      keep_default=False)

        # Adding field 'ProductGapWidth.movement_finder'
        db.add_column(u'catalogue_productgapwidth', 'movement_finder',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='movements', null=True, to=orm['catalogue.Movement']),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'ProductGapWidth.gap_width_finder'
        db.delete_column(u'catalogue_productgapwidth', 'gap_width_finder_id')

        # Deleting field 'ProductGapWidth.movement_finder'
        db.delete_column(u'catalogue_productgapwidth', 'movement_finder_id')
    ...
    models = {
        ...
        u'catalogue.productgapwidth': {
            ...
            'gap_width_finder': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'gap_widths'", 'null': 'True', 'to': u"orm['catalogue.GapWidth']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'movement_finder': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'movements'", 'null': 'True', 'to': u"orm['catalogue.Movement']"}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'order': ('django.db.models.fields.PositiveIntegerField', [], {'default': '0'}),
