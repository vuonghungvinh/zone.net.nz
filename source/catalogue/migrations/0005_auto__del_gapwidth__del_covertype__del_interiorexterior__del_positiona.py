...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting model 'GapWidth'
        db.delete_table(u'catalogue_gapwidth')
        ...
        db.delete_table(u'catalogue_movement')

        # Deleting model 'FireRating'
        db.delete_table(u'catalogue_firerating')


        # Changing field 'ProductGapWidth.cover_type'
        db.alter_column(u'catalogue_productgapwidth', 'cover_type_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['balco_specific.CoverType']))

        # Changing field 'ProductGapWidth.movement_finder'
        db.alter_column(u'catalogue_productgapwidth', 'movement_finder_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['balco_specific.Movement']))

        # Changing field 'ProductGapWidth.fire_rating'
        db.alter_column(u'catalogue_productgapwidth', 'fire_rating_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['balco_specific.FireRating']))

        # Changing field 'ProductGapWidth.interior_exterior'
        db.alter_column(u'catalogue_productgapwidth', 'interior_exterior_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['balco_specific.InteriorExterior']))

        # Changing field 'ProductGapWidth.position_application'
        db.alter_column(u'catalogue_productgapwidth', 'position_application_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['balco_specific.PositionApplication']))

        # Changing field 'ProductGapWidth.gap_width_finder'
        db.alter_column(u'catalogue_productgapwidth', 'gap_width_finder_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['balco_specific.GapWidth']))

    def backwards(self, orm):
        # Adding model 'GapWidth'
        db.create_table(u'catalogue_gapwidth', (
            ('updated', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
        ))
        db.send_create_signal(u'catalogue', ['GapWidth'])
        ...
        db.create_table(u'catalogue_movement', (
            ('updated', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
        ))
        db.send_create_signal(u'catalogue', ['Movement'])
        ...
        # Changing field 'ProductGapWidth.cover_type'
        db.alter_column(u'catalogue_productgapwidth', 'cover_type_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['catalogue.CoverType']))

        # Changing field 'ProductGapWidth.movement_finder'
        db.alter_column(u'catalogue_productgapwidth', 'movement_finder_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['catalogue.Movement']))

        # Changing field 'ProductGapWidth.fire_rating'
        db.alter_column(u'catalogue_productgapwidth', 'fire_rating_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['catalogue.FireRating']))

        # Changing field 'ProductGapWidth.interior_exterior'
        db.alter_column(u'catalogue_productgapwidth', 'interior_exterior_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['catalogue.InteriorExterior']))

        # Changing field 'ProductGapWidth.position_application'
        db.alter_column(u'catalogue_productgapwidth', 'position_application_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['catalogue.PositionApplication']))

        # Changing field 'ProductGapWidth.gap_width_finder'
        db.alter_column(u'catalogue_productgapwidth', 'gap_width_finder_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['catalogue.GapWidth']))
    ...
    models = {
        ...
        u'catalogue.productgapwidth': {
            ...
            'description': ('django.db.models.fields.TextField', [], {}),
            'excerpt': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            'fire_rating': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'fire_ratings'", 'null': 'True', 'to': u"orm['balco_specific.FireRating']"}),
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'interior_exterior': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'interior_exteriors'", 'null': 'True', 'to': u"orm['balco_specific.InteriorExterior']"}),
            ...
            'name': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'order': ('django.db.models.fields.PositiveIntegerField', [], {'default': '0'}),
            'position_application': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'position_applications'", 'null': 'True', 'to': u"orm['balco_specific.PositionApplication']"}),
            'slug': ('django.db.models.fields.SlugField', [], {'max_length': '255'}),
            'updated': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'})
        },
