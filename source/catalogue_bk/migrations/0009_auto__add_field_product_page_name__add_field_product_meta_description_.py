...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Product.page_name'
        db.add_column(u'catalogue_product', 'page_name',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Product.meta_description'
        db.add_column(u'catalogue_product', 'meta_description',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Category.page_name'
        db.add_column(u'catalogue_category', 'page_name',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Category.meta_description'
        db.add_column(u'catalogue_category', 'meta_description',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Product.page_name'
        db.delete_column(u'catalogue_product', 'page_name')

        # Deleting field 'Product.meta_description'
        db.delete_column(u'catalogue_product', 'meta_description')

        # Deleting field 'Category.page_name'
        db.delete_column(u'catalogue_category', 'page_name')

        # Deleting field 'Category.meta_description'
        db.delete_column(u'catalogue_category', 'meta_description')
