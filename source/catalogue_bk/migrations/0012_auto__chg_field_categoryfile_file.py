...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'CategoryFile.file'
        db.alter_column(u'catalogue_categoryfile', 'file', self.gf('django.db.models.fields.files.FileField')(max_length=100))

    def backwards(self, orm):

        # Changing field 'CategoryFile.file'
        db.alter_column(u'catalogue_categoryfile', 'file', self.gf('django.db.models.fields.files.ImageField')(max_length=100))
