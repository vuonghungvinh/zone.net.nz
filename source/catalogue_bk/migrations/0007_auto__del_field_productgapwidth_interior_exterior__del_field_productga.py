...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding M2M table for field position_application on 'ProductGapWidth'
        m2m_table_name = db.shorten_name(u'catalogue_productgapwidth_position_application')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('productgapwidth', models.ForeignKey(orm[u'catalogue.productgapwidth'], null=False)),
            ('positionapplication', models.ForeignKey(orm[u'balco_specific.positionapplication'], null=False))
        ))
        db.create_unique(m2m_table_name, ['productgapwidth_id', 'positionapplication_id'])

        # Adding M2M table for field interior_exterior on 'ProductGapWidth'
        m2m_table_name = db.shorten_name(u'catalogue_productgapwidth_interior_exterior')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('productgapwidth', models.ForeignKey(orm[u'catalogue.productgapwidth'], null=False)),
            ('interiorexterior', models.ForeignKey(orm[u'balco_specific.interiorexterior'], null=False))
        ))
        db.create_unique(m2m_table_name, ['productgapwidth_id', 'interiorexterior_id'])


    def backwards(self, orm):
        # Adding field 'ProductGapWidth.interior_exterior'
        db.add_column(u'catalogue_productgapwidth', 'interior_exterior',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='interior_exteriors', null=True, to=orm['balco_specific.InteriorExterior'], blank=True),
                      keep_default=False)

        # Adding field 'ProductGapWidth.position_application'
        db.add_column(u'catalogue_productgapwidth', 'position_application',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='position_applications', null=True, to=orm['balco_specific.PositionApplication'], blank=True),
                      keep_default=False)

        # Removing M2M table for field position_application on 'ProductGapWidth'
        db.delete_table(db.shorten_name(u'catalogue_productgapwidth_position_application'))

        # Removing M2M table for field interior_exterior on 'ProductGapWidth'
        db.delete_table(db.shorten_name(u'catalogue_productgapwidth_interior_exterior'))
