...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'catalogue_categoryfile', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('file', self.gf('django.db.models.fields.files.ImageField')(max_length=100)),
            ('category', self.gf('django.db.models.fields.related.ForeignKey')(related_name='category_files', to=orm['catalogue.Category'])),
            ('created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('updated', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
        ))
        db.send_create_signal(u'catalogue', ['CategoryFile'])

        # Adding field 'Product.sub_title'
        db.add_column(u'catalogue_product', 'sub_title',
    ...
    def backwards(self, orm):
        ...
        db.delete_table(u'catalogue_categoryfile')

        # Deleting field 'Product.sub_title'
        db.delete_column(u'catalogue_product', 'sub_title')
    ...
    models = {
        ...
        u'catalogue.categoryfile': {
            'Meta': {'ordering': "('id',)", 'object_name': 'CategoryFile'},
            'category': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'category_files'", 'to': u"orm['catalogue.Category']"}),
            'created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
        ...
        u'catalogue.product': {
            ...
            'sub_title': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
            'updated': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'})
        },
