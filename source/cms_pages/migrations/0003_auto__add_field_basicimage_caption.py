...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'BasicImage.caption'
        db.add_column(u'cms_pages_basicimage', 'caption',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'BasicImage.caption'
        db.delete_column(u'cms_pages_basicimage', 'caption')
